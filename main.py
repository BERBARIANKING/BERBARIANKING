...
def main():
    ...
    t.gen_text(f"Copyright (C) {year_now}, \x1b[31mNikolaos Berbaris Softwares Inc.\x1b[0m", 2)
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("Nikolaos Berbaris", 3, contin=True)
    ...
    \x1b[30;101mBERBARIANKING@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mArch/Gentoo Linux, Windows 11, Android 13\x1b[0m
      \x1b[96mHost:   \x1b[93mInformation and Communication Systems Engineering (ICSD) \x1b[94m#NSEC\x1b[0m
    ...
    --------------
    \x1b[96mEmail:      \x1b[93micsd20146@icsd.aegean.gr\x1b[0m
    \x1b[96mLinkedIn:   \x1b[93Nikolas Berbaris\x1b[0m
    ...
    t.gen_typing_text(" -u Nikolas_Berbaris", 1, contin=True)
